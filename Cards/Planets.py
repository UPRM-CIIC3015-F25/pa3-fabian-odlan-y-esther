...
# DONE ESTHER (TASK 6.1): Implement the Planet Card system for Balatro.
...
PLANETS = {
    "Mercury": PlanetCard("Mercury", "levels up High Card", 3, 5, 1),
    "Venus": PlanetCard("Venus", "levels up One Pair", 4, 8, 2),
    "Earth": PlanetCard("Earth", "levels up Two Pair", 5, 12, 2),
    "Mars": PlanetCard("Mars", "levels up Three of a Kind", 6, 15, 3),
    "Jupiter": PlanetCard("Jupiter", "levels up Straight", 7, 18, 4),
    "Saturn": PlanetCard("Saturn", "levels up Flush", 8, 22, 4),
    "Uranus": PlanetCard("Uranus", "levels up Full House", 9, 25, 5),
    "Neptune": PlanetCard("Neptune", "levels up Four of a Kind", 10, 30, 6),
    "Pluto": PlanetCard("Pluto", "levels up Straight Flush", 11, 35, 6),
    "Sun": PlanetCard("Sun", "levels up all hands", 15, 45, 7),
